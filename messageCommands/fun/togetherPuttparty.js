...
module.exports = {
    name: "puttparty",
    aliases: ['together-puttparty', 'puttparty-together'],
    description: "Play Puttparty in a voice channel together!",
    ...
    run: async (client, message, args) => {
        ...
        discordTogether.createTogetherCode(channel.id, "puttparty")
