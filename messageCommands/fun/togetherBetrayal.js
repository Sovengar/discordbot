...
module.exports = {
    name: "betrayal",
    aliases: ['together-betrayal', 'betrayal-together'],
    description: "Play Betrayal in a voice channel together!",
    ...
    run: async (client, message, args) => {
        ...
        discordTogether.createTogetherCode(channel.id, "betrayal")
