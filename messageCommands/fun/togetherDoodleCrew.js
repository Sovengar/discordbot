...
module.exports = {
    name: "doodlecrew",
    aliases: ['together-doodlecrew', 'doodlecrew-together'],
    description: "Play Doodlecrew in a voice channel together!",
    ...
    run: async (client, message, args) => {
        ...
        discordTogether.createTogetherCode(channel.id, "doodlecrew")
