...
module.exports = {
    name: "lettertile",
    aliases: ['together-lettertile', 'lettertile-together'],
    description: "Play Lettertile in a voice channel together!",
    ...
    run: async (client, message, args) => {
        ...
        discordTogether.createTogetherCode(channel.id, "lettertile")
