...
module.exports = {
    ...
    type: "CHAT_INPUT",
    options: [
        { name: "user", description: "Select a user", type: 6, required: true,},
        { name: "reason", description: "State a reason to mute", type: 3, required: false,},
    ],
    /**
     *
     * @param {Client} client
    ...
    */
    run: async (client, interaction, args) => {
        try {
            ...
            let muteAskEmbed = new MessageEmbed()
                .setColor('#3d35cc')
                .setDescription('**⚠️ - Do you really want to mute this member?**')

            let muteEndEmbed = new MessageEmbed()
                .setColor('#3d35cc')
            ...
            const dmmuteEmbed = new MessageEmbed()
            ...
            const mtlogEmbed = new MessageEmbed()
                .setColor('#3d35cc')
            ...
            col.on('collect', async (i) => {
                ...
                if (i.customId === 'muteyes') {
                    ...
                    const memrerrEmbed = new MessageEmbed()
                        .setColor('#3d35cc')
                        .setDescription("‼️ - You cannot mute a member of your same level or higher!")

                    const botrerrEmbed = new MessageEmbed()
                        .setColor('#3d35cc')
                    ...
                    if (!role) {
                        ...
                        const rcrsucEmbed = new MessageEmbed()
                            .setColor('#3d35cc')
                    ...
                    GuildSettings.findOne({ guild_id: interaction.guild.id }, async (err, data) => {
                        if (!data) {
                            ...
                            data.mutedUsers.push(member.id)
                            data.save()
                        }
                    })
