...
module.exports = {
    ...
    options: [
        { name: "add", description: "Adds timeout to a member for a specific duration", type: "SUB_COMMAND",
            options: [
                { name: "user", description: "Select a member", type: "USER", required: true},
                { name: "duration", description: "Select the duration for the timeout", type: "STRING", required: true,
                    choices: [
                ...
                { name: "reason", description: "Provide a reason for the timeout", type: "STRING", required: false},
            ]
        },
        { name: "remove", description: "Removes timeout from a member", type: "SUB_COMMAND",
            options: [
                { name: "user", description: "Select a member", type: "USER", required: true }
            ]
        },
